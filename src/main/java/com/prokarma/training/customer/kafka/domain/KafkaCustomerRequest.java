...
public class KafkaCustomerRequest {
	...
	public String toString() {
		return "KafkaCustomerRequest [customerNumber=" + customerNumber + ", firstName=" + firstName + ", lastName="
				+ lastName + ", birthdate=" + birthdate + ", country=" + country + ", countryCode=" + countryCode
